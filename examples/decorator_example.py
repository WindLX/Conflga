...
if __name__ == "__main__":
    ...
    print("2. 使用命令行覆盖:")
    print("   python decorator_example.py --conflga-override learning_rate=0.01 --conflga-override batch_size=64 --conflga-override epochs=20\n")
    
    print("3. 复杂嵌套配置:")
    print("   python decorator_example.py --conflga-override model.architecture=resnet --conflga-override model.layers=50 --conflga-override optimizer.type=adam\n")
